...
# Change the second item in the list (i.e. 'bread') to 'rice' instead, then print the second item to the screen
...
list_two = ['toffee', 'coffee']
shopping_list.extend(list_two)
